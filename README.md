...
##### Проект доступен по адресу https://itfox-vrboroday.b4a.run/
...
### В задании было указано, что доступно только 2 роли, поэтому все запросы доступны только авторизованным пользователям
### Эндпоинты (если локально, то относительно http://localhost/, иначе относительно https://itfox-vrboroday.b4a.run/)
